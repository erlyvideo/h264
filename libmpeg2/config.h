...
#define CONFIGURATION "--prefix=/usr/local/Cellar/mplayer/HEAD"

#define MPLAYER_DATADIR "/usr/local/Cellar/mplayer/HEAD/share/mplayer"
#define MPLAYER_CONFDIR "/usr/local/Cellar/mplayer/HEAD/etc/mplayer"
#define MPLAYER_LIBDIR "/usr/local/Cellar/mplayer/HEAD/lib"
...
#undef CONFIG_XMMS
#define BINARY_CODECS_PATH "/usr/local/Cellar/mplayer/HEAD/lib/codecs"
